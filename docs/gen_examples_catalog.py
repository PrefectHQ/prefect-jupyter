...
import prefect_jupyter

COLLECTION_SLUG = "prefect_jupyter"
...
for _, module_name, ispkg in iter_modules(prefect_jupyter.__path__):
...
with mkdocs_gen_files.open(examples_catalog_path, "w") as generated_file:
    generated_file.write(
        dedent(
            ...
            Below is a list of examples for `prefect-jupyter`.
            """
        )
    )
